console.log("COMPARISION OPERATORS  THERE ARE TOTAL 9 COMAPARISION OPERATORS.");
console.log("> GREATER THAN.");
console.log("< LESS THAN.");
console.log(">= GREATER THA EQUAL TO.");
console.log(">= LESS THA EQUAL TO.");
...
console.log("%c?: TERNARY OPERATOR ","color : hotpink;");
console.log("%cTERNARY OPERATOR IS USED IN IF ELSE AND TRUE AND FALSE BLOCK OF CODE.","color : hotpink;");
